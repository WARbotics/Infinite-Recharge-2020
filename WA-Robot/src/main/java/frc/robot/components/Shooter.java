...
public class Shooter {
    ...
    private Boolean motorInSync() {
        double velocityDifference = Math.abs((leftShooter.getClosedLoopTarget() - leftShooter.getErrorDerivative())
                - (rightShooter.getClosedLoopTarget() - rightShooter.getErrorDerivative()));
